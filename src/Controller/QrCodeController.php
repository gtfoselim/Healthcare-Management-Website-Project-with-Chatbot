...
class QrCodeController extends AbstractController
{
    ...
    #[Route('/qr-codes', '/{idEvenement}', name: 'app_qr_codes', methods: ['GET'])]
    public function index(): Response
    {
        $writer = new PngWriter();
        $evenement = new Evenement();
        $idEvenement = $evenement->getId();
        $idEvenement = $evenement->getNomEvenement();
        $idEvenement = $evenement->getTypeEvenement();
        $idEvenement = $evenement->getNbParticipants();
        ...
        return $this->render('qr_code/indexEvenement.html.twig', $qrCodes);
    }
}
