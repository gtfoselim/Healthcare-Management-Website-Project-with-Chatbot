        ...
        public function generatePdf(MedecinRepository $userRepository): Response
{
    ...
    return $this->render('user/docchart.html.twig', [
        ...
        public function isHealthQuestion(string $question): bool
        {
            // Implement your logic to determine if the question is related to health
            ...
            $healthKeywords = [
                ...
                'respiratory', 'immune system', 'cancer','heart', 'stroke', 'diabetes', 'allergy', 'asthma',
        ...
        public function chat(Request $request, SessionInterface $session): Response
        {
            ...
            if ($request->isMethod('POST')) {
                ...
                if (!empty($question)) {
                    ...
                    if ($this->isHealthQuestion($question)) {
                        ...
                        // If the question is not health-related, provide a default response
                        $response = "I'm sorry, I can only respond to health-related questions at the moment.";
                    }
                }
            }
